  ...
  const handleSubmit = async () => {
    ...
    try {
      const issue = await createIssueMutation.mutateAsync({
        ...
        target_server_id: targetServerId || undefined,
        ops_intent: opsIntent.trim() || undefined,
          ...
          <>
            ...
            <div className="border-t px-4 py-3 shrink-0">
              <div className="mb-2 flex items-center justify-between">
                <div className="text-xs font-medium">Ops context</div>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <label className="grid gap-1 text-xs">
                  ...
                  >
                    <option value="">No target server</option>
                    {servers.map((server) => (
                ...
                <label className="grid gap-1 text-xs sm:col-span-2">
                  <span className="text-muted-foreground">Ops intent</span>
                  <Input
                    aria-label="Ops intent"
                    value={opsIntent}
                    onChange={(event) => setOpsIntent(event.target.value)}
